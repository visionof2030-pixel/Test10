...
<div class="container">
  ...
  <div class="box objective">
    ...
    تركز على التعلم النشط والعمل الجماعي وتنمية مهارات التفكير.
  </div>
  ...
  <div class="main-grid">
    ...
    <div class="box">
      ...
      باستخدام أساليب تعليمية حديثة.
    </div>

    <div class="box recommend">
      <div class="box-title">التوصيات</div>
      تكرار استخدام الأنشطة التفاعلية، تخصيص وقت كافٍ للمراجعة،
      استخدام وسائل بصرية وتقنية داعمة.
    </div>

    <div class="box result">
      <div class="box-title">النتائج</div>
      استيعاب غالبية الطلاب للمفهوم، مشاركة فعالة في الأنشطة،
      إنجاز التمارين وتحقيق أهداف الدرس.
    </div>

    <div class="box strength">
      <div class="box-title">نقاط القوة</div>
      وضوح الشرح، تنوع الأنشطة، إدارة الوقت بفاعلية،
      مراعاة الفروق الفردية بين الطلاب.
    </div>

    <div class="box motivation">
      <div class="box-title">المحفزات</div>
      تفاعل الطلاب الإيجابي، تحفيز روح التنافس بين المجموعات،
      استخدام وسائل تعليمية جذابة.
    </div>

    <div class="box weakness">
      <div class="box-title">مواطن القصور</div>
      نقص بعض الوسائل التعليمية، محدودية المساحة الصفية،
      ضعف مشاركة عدد محدود من الطلاب.
    </div>

    <div class="box challenge">
      <div class="box-title">التحديات</div>
      تفاوت سرعة الاستيعاب بين الطلاب، قصر وقت الحصة،
      صعوبة بعض المفاهيم العلمية.
    </div>
    ...
    <div class="evidence-grid">
      <div class="evidence-box">
        ...
        <div class="evidence-caption">
          تنفيذ النشاط داخل الفصل الدراسي من خلال العمل التعاوني
          بين الطلاب، وتطبيق استراتيجيات التعلم النشط.
        </div>
      </div>
      ...
      <div class="evidence-box">
        ...
        <div class="evidence-caption">
          نماذج من أعمال الطلاب أثناء النشاط، توضح تنوع المهام
          بين الإبداع والتحدي وتنمية مهارات التفكير.
        </div>
      </div>
    </div>
  </div>
